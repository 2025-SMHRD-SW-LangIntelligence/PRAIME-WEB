...
public class DailyLogService {
	...
	@Transactional
	public void saveLog(String dltitle, String dlcontent, String dlweather, Float dltemp, LocalDateTime dldate,
			String dlcrop, String dlwork, // 농작업 필드 추가
		...
		log.setDldate(dldate); // 날짜 문자열을 LocalDate로 변환
		...
		if (deletedImageIds != null && !deletedImageIds.isEmpty()) {
			...
			while (iterator.hasNext()) {
				...
				if (deletedImageIds.contains(image.getDliid())) {
					String imagePath = uploadDir + image.getDlipath();
